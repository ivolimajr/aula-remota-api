    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RolesModelUsuarioModel", x => new { x.RolesId, x.UsuariosId });
                    table.ForeignKey(
                        name: "FK_RolesModelUsuarioModel_Roles_RolesId",
                        column: x => x.RolesId,
                        principalTable: "Roles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RolesModelUsuarioModel_Usuario_UsuariosId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RolesModelUsuarioModel_UsuariosId",
                table: "RolesModelUsuarioModel",
                column: "UsuariosId");
