...
namespace AulaRemota.Core.Services.Auth
{
    public class TokenServices : ITokenServices
    {
        ...
        string ITokenServices.GenerateAccessToken(IEnumerable<Claim> claims)
        {
        ...
        string ITokenServices.GenerateRefreshToken()
        {
        ...
        ClaimsPrincipal ITokenServices.GetClaimsPrincipalFromExpiredToken(string token)
        {
