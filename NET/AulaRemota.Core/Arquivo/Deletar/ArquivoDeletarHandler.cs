...
{
    public class ArquivoDeletarHandler : IRequestHandler<ArquivoDeletarInput, bool>
    {
        ...
        async Task<bool> IRequestHandler<ArquivoDeletarInput, bool>.Handle(ArquivoDeletarInput request, CancellationToken cancellationToken)
        {
            try
            {
                if (request.TipoUsuario == null) throw new CustomException(new ResponseModel() { UserMessage = "Informe o tipo de usuário", ModelName = nameof(ArquivoDeletarInput), StatusCode = HttpStatusCode.BadRequest });
            ...
            catch (CustomException e)
            {
                throw new CustomException(new ResponseModel
                {
                    ...
                    ModelName = nameof(ArquivoDeletarHandler),
                    Exception = e,
