...
namespace AulaRemota.Shared.Helpers.Extensions
{
    public static class TypeExtensions
    {
        ...
        /// </summary>
        /// <typeparam name="TTarget">Tipo de destino</typeparam> (como reverso).
        ...
        /// </summary>
        /// <param name="type">O tipo para obter suas classes base.</param>
        /// <param name="stoppingType">Um tipo para parar de ir para as classes base mais profundas. Este tipo será incluído no array retornado</param>
        /// <param name="includeObject">Verdadeiro, para incluir o tipo padrão <see cref="T:System.Object" /> no array retornado.</param>
